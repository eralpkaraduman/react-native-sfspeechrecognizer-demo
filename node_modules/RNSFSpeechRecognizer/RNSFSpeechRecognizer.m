...
//  Copyright © 2017 Super Damage. All rights reserved.
//
...
// TODO: handle deinit and destroy the manager
...
RCT_EXPORT_METHOD(destroy) // TODO: do i need this?
{
    //[_manager setDelegate:nil]; // breaks the singleton design, remove if wont move to instances
    [_manager destroy];
}
